...
function checkCategories () {
  ...
  if (elixrs.every(buff => found.includes(buff))) {
    document.getElementById('elixrs').classList.add('categoryComplete')
  }
...
let buffList = [
  ...
  { display: 'WH', algo: 'sayram-white-bg' },
  { display: 'door', algo: 'aurelia-white-bg' }
];
